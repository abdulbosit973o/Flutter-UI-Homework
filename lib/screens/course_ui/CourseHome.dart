...
import 'package:homework_lesson_5/screens/course_ui/recommend.dart';
import 'package:iconsax/iconsax.dart';

import '../music/second_file/navigation_controller/NavigationController.dart';
        ...
        child: Row(
          ...
          children: <Widget>[
            _card(context,
                ...
                isPrimaryCard: true,
                imgPath:
                "https://www.visafranchise.com/wp-content/themes/bridge-child/img/about-us/our-team-1.webp"),
            _card(context,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: Obx(
          ...
          onDestinationSelected: (index) => funNavigate(index),
          destinations: const [
